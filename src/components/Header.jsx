        ...
        <div className="subheader bg-[#282828] py-[15px]">
            <div className="contain max-w-container mx-auto flex justify-between">
                <div className="contact flex gap-4">
                    <div className="mail text-[white] flex gap-1"><MdMailOutline /> mail@yourcompany.com</div>
                    <div className="mail text-[white] flex gap-1"><FaPhoneAlt /> +896 120 5889 (Toll free)</div>
                </div>
